...
public interface ClassSetMapper {
     ...
     * @return
     */
    List<ClassVo> selectAllClass(ClassSet classSet);
    /**
     * 获取所有的课程列表
     * 包括套课程 和 单独的节课程
     * @param merchantId
     * @return
     */
    List<ClassVo> selectAllClassOrderById(@Param("merchantId") String merchantId,@Param("queryType") Integer queryType);
